...
class i2c_master_tb_macro_class:        
    ...
    def start_i2c_master(self, chip_addr, rnw, nb_data, polling = False):
        ...
        self.scn.SET("POLLING", 1 if polling == True else 0)       # Set polling 0 or 1
        ...
        self.scn.SET("POLLING",   0) # Reset to 0
