...
add wave -noupdate -expand -group {TOP DUT} -group {RAM STATIC I/F} -radix hexadecimal /tb_top/i_dut/i_rdata_static
add wave -noupdate -expand -group {TOP DUT} -group {RAM STATIC I/F} -radix hexadecimal /tb_top/i_dut/o_me_static
add wave -noupdate -expand -group {TOP DUT} -group {RAM STATIC I/F} -radix hexadecimal /tb_top/i_dut/o_we_static
add wave -noupdate -expand -group {TOP DUT} -group {RAM STATIC I/F} -radix hexadecimal /tb_top/i_dut/o_addr_static
add wave -noupdate -expand -group {TOP DUT} -group {RAM STATIC I/F} -radix hexadecimal /tb_top/i_dut/o_wdata_static
